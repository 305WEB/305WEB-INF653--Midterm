...
<section>
    ...
    <!----------------------------------------------------------------------------------------------------------  -->
        ...
        <a href=".?action=list_makes" class="top-link">Edit makes</a>
        ...
        <!-- <li class="item-3">
        <button class="add_button" type="submit" name="action" value="add_vehicle"><strong>Add <br/>Item</strong></button> 
